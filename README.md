...
| `test_dashboard.py` | Streamlit dashboard renders and shows inventory metrics (AppTest); also covers the Purchase Orders page (`dashboard/pages/2_Purchase_Orders.py`) |
